...
class XrayAnalysis(models.Model):
    STATUS_CHOICES = [("ok", "Analyzed"), ("unsupported_body_part", "Unsupported body part"), ("models_not_trained", "Model not trained yet"), ("error", "Error")]
    ...
    def __str__(self):
        return f"X-ray analysis #{self.pk}"
